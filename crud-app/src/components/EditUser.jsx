import { useState, useEffect } from 'react';//by which we can use the API for storing DATA.
...
const EditUser = () =>{
    ...
    } // this setUser value is now stored in the line 28 in user, so we can get values from that.
